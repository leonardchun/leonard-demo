package com.leonard.cache.modules.webservice.service.impl;

import com.leonard.cache.modules.webservice.service.IPictureService;
 ...
 */
@WebService(serviceName ="PictureServiceImpl",portName = "TestWsdlImpl",targetNamespace = "DefaultNamespace",endpointInterface = "com.leonard.cache.modules.webservice.service.IPictureService")
